...
class SuperController {
     ...
     */
     ...
     setupOptionsTabs(){
         ...
         this.aboutNavOption = document.getElementById("navbarAbout");
         let aboutControllerRef = this.aboutController;
         this.aboutNavOption.addEventListener("click", function(){thisRef.tabToggleListener(this, aboutControllerRef)}, false);
     }
